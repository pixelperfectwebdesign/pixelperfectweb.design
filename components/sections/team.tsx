...
function TeamMember({ name, role, image, bio, index }: TeamMemberProps) {
  return (
    <Card
      className={cn("overflow-hidden group team-card opacity-0 translate-y-4")}
...
export default function Team() {
  ...
  const team = [
    {
      name: "Dylan Baker",
      role: "Designer / Strategist & Co-Founder",
      image:
      ...
      <div className="container px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between mb-12">
          <h2 className="text-3xl md:text-4xl font-bold max-w-md mb-4 md:mb-0">
            Meet the <span className="text-primary">Founders</span> behind our
            success
          </h2>
